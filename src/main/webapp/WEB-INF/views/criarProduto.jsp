                            ...
                            <c:otherwise>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" id="produto_data_fabricacao"  name="produto_data_fabricacao" value="${produtoEdita.produto_data_fabricacao}" class="form-control" placeholder="0001">
                                            </div>
                                        </div>
                                    </div>
                                </div>
